...
public abstract class SliverFishEntityMixin extends HostileEntity implements Bucketable {

    @Unique
    private static final TrackedData<Boolean> FROM_BOTTLE = DataTracker.registerData(SliverFishEntityMixin.class, TrackedDataHandlerRegistry.BOOLEAN);

    protected SliverFishEntityMixin(EntityType<? extends HostileEntity> entityType, World world) {
